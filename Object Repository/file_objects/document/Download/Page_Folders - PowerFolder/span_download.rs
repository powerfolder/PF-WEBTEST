...
<WebElementEntity>
   ...
   <selectorCollection>
      ...
      <entry>
         <key>XPATH</key>
         <value>//thead[@id='files_select_header']//div[contains(concat(' ',normalize-space(@class),' '),' pica-table-selection-context ')]//a[contains(concat(' ',normalize-space(@class),' '),' files-ui-download ')]/span</value>
      </entry>
   </selectorCollection>
