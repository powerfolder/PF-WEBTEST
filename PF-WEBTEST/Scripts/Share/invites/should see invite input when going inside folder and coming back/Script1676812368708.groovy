...
isElementNotVisible = WebUI.verifyElementNotVisible(findTestObject('Object Repository/div_Invite users and groups or create a lin_ba0936'))

assert isElementNotVisible
...
WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn))
 ...
 isElementPresent = WebUI.verifyElementPresent(findTestObject('Object Repository/div_Invite users and groups or create a lin_ba0936'), 10)

assert isElementPresent

 isVisible = WebUI.verifyElementVisible(findTestObject('Object Repository/div_Invite users and groups or create a lin_ba0936'))
