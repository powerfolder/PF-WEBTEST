...
WebUI.verifyElementPresent(findTestObject('Folders/Page_Folders - PowerFolder/Rescan_filesystem'), 5)

WebUI.click(findTestObject('Folders/Page_Folders - PowerFolder/Rescan_filesystem'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Folders/Page_Folders - PowerFolder/Popup_Rescan'), 3)

WebUI.verifyElementText(findTestObject('Folders/Page_Folders - PowerFolder/Popup_Rescan'), 'Filesystem scan successfully triggered. New and changed files will show up after the folder has been completely scanned.')
