...
WebUI.check(findTestObject('Accounts/Edit_Accounts - PowerFolder/button_Reseller'))
...
boolean isClickable = WebUI.verifyElementClickable(findTestObject('Object Repository/Accounts/Edit_Accounts - PowerFolder/button_Reseller'), 
