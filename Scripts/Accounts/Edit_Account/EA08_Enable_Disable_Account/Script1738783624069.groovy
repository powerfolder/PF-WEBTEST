...
WebUI.click(findTestObject('Accounts/Edit_Accounts - PowerFolder/button_Active'))
...
WebUI.verifyElementNotChecked(findTestObject('Accounts/Edit_Accounts - PowerFolder/button_Active'), 5)
