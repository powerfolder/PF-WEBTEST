...
WebUI.click(findTestObject('Object Repository/Accounts/Page_Accounts - PowerFolder/span_admin_glyphicons glyphicons-user pica-glyph'))

WebUI.click(findTestObject('Object Repository/Accounts/Page_Accounts - PowerFolder/a_Import Accounts'))

WebUI.click(findTestObject('Object Repository/Accounts/Page_Accounts - PowerFolder/span_Add file'))
