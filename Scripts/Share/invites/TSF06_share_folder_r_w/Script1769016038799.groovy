...
// create file to verify r/w permission

WebUI.verifyElementPresent(findTestObject('file_objects/document/Page_Folders - PowerFolder/Create_Itemes_Insid_a_folder'),10)
