...
String  mails = "a_${-> folderName}@a.com;b_${-> folderName}@b.com:c_${-> folderName}@c.com,d_${-> folderName}@d.com"
...
assert membersCount+4 == CustomKeywords.'share.ShareHelper.getMembersCount'()
