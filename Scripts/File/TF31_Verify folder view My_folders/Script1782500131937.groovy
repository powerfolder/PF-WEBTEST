...
TestObject myFolders = new TestObject('Invitations')

myFolders.addProperty('xpath', ConditionType.EQUALS, '//a[normalize-space()=\'My Folders\']')

WebUI.waitForElementClickable(myFolders, 10)

WebUI.click(myFolders)
