...
WebUI.verifyElementClickable(findTestObject('file_objects/presentation/Page_Folders - PowerFolder/Create presentation'))

WebUI.click(findTestObject('file_objects/presentation/Page_Folders - PowerFolder/Create presentation'))

String characters = 'äöüß'

String PresentationName = (('Presentation_' + RandomStringUtils.randomNumeric(2)) + '_') + RandomStringUtils.random(2, characters)
...
def btn = findDoc(PresentationName)
...
@Keyword
WebElement findDoc(String PresentationName) {
    WebDriver driver = DriverFactory.getWebDriver()

    return driver.findElement(By.xpath(('//*[contains(@data-search-keys, \'' + PresentationName) + '\')]/td[1]/span'))
}
