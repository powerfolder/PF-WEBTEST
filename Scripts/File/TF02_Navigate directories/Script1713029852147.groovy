...
String folderName3 = (('Ordner_' + RandomStringUtils.randomNumeric(2)) + '_') + RandomStringUtils.random(2, characters)
...
WebElement btn4 = findFolder(folderName1)

WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn4))

WebElement btn5 = findFolder(folderName2)
...
WebElement btn6 = findFolder(folderName3)
