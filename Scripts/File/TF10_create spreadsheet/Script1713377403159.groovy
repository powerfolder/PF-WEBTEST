...
WebUI.verifyElementClickable(findTestObject('file_objects/Spreadsheet/Page_Folders - PowerFolder/span_Create spreadsheet'))
...
String sheetName = (('sheet_' + RandomStringUtils.randomNumeric(2)) + '_') + RandomStringUtils.random(2, characters)
