...
List<String> subgroupNames = [groupName_2, groupName_3, groupName_4]
...
def btn_for_sub_1 = findGroup(groupName_2)

WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn_for_sub_1))

WebUI.delay(2)

assert groupName_2 != null

WebUI.refresh()

WebUI.delay(2)

def btn_for_sub_2 = findGroup(groupName_3)

WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn_for_sub_2))

WebUI.delay(2)

assert groupName_3 != null

WebUI.refresh()

WebUI.delay(2)

def btn_for_sub_3 = findGroup(groupName_4)

WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn_for_sub_3))

WebUI.delay(2)

assert groupName_4 != null
...
WebElement findGroup(String groupName) {
    ...
    return driver.findElement(By.xpath("//tr[contains(@data-search-keys, '$groupName')]/td[1]/span"))
}
