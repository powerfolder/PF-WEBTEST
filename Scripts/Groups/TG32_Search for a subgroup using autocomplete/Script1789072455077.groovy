...
String part_1 = RandomStringUtils.randomNumeric(4)

String part_2 = RandomStringUtils.randomNumeric(4)

String groupName_2 = part_1 + '_' + part_2
...
WebElement group1 = new WebDriverWait(
	driver,
...
// Vérifier que le groupe 2 est présent dans la partie Subgroup
WebUI.verifyMatch(
	tooltipText,
	"(?s).*Subgroup:\\s*${java.util.regex.Pattern.quote(groupName_2)}.*",
	true
)
