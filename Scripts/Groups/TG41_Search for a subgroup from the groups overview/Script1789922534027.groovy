...
WebUI.waitForElementVisible(findTestObject('Groups/Search group'), 5)

WebUI.setText(findTestObject('Groups/Search group'), groupName_2)

WebUI.sendKeys(findTestObject('Groups/Search group'),Keys.chord(Keys.ENTER))
