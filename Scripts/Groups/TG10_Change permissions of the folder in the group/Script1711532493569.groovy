...
WebUI.click(findTestObject('Page_Groups - PowerFolder/span_Can administrate'))
...
WebUI.verifyElementVisible(findTestObject('Groups/Page_Groups - PowerFolder/button_Can administrate'))
