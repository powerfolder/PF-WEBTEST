...
// 'user1' adds himself as the SOLE member+admin - no second admin, that is the point of this test.
...
// Re-open the group and try to remove himself.
WebUI.refresh()
...
// Clicking it anyway must be a no-op: the row stays, and it stays admin.
