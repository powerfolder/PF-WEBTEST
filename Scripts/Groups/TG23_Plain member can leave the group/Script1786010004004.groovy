...
// 'user1' adds himself as member+admin, so the group has a real admin once 'user2' leaves.
...
// 'user2' is added as a PLAIN member - never promoted, default role stays "Is member".
...
// Log out of 'user1', log in as the plain member 'user2' to attempt the leave himself.
WebUI.click(findTestObject('My_Account/Overview/Page_Accounts - PowerFolder/Icon_account'))
