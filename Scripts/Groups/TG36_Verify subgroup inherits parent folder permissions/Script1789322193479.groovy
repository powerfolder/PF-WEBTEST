...
// Folder 1 : Can read
changeFolderPermission(Folder_1, 'Can read')

// Création du deuxième dossier
...
// Folder 2 : Can read and write
changeFolderPermission(Folder_2, 'Can read and write')

// Création du troisième dossier
WebUI.setText(findTestObject('Object Repository/Groups/Page_Groups - PowerFolder/input_Delete_pica-taginput-input form-control'), 
    Folder_3)
...
// Folder 3 : Can administrate
changeFolderPermission(Folder_3, 'Can administrate')
...
WebUI.verifyElementText(findTestObject('Groups/Page_Groups - PowerFolder/Can read (inherited)'), 'Can read (inherited)', 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Groups/Page_Groups - PowerFolder/Can read and write (inherited)'), 'Can read and write (inherited)', 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Groups/Page_Groups - PowerFolder/Can administrate (inherited)'), 'Can administrate (inherited)', 
    FailureHandling.STOP_ON_FAILURE)
