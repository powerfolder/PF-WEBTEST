...
WebUI.setText(findTestObject('Organization/InputName'), "TestAutomation")
WebUI.click(findTestObject('Organization/SaveButton'))
WebUI.verifyEqual(WebUI.getText(findTestObject('Organization/VerifyOrganizationName')), 'TestAutomation',  FailureHandling.CONTINUE_ON_FAILURE)
WebUI.delay(10)
WebUI.click(findTestObject('Organization/SelectCreatedOrganization'))
WebUI.click(findTestObject('Organization/Deletebutton'))
WebUI.delay(3)
WebUI.verifyEqual(WebUI.getText(findTestObject('Organization/VerfiyDeleteMsg')), 'Do you really want to delete TestAutomation with all members and folders?',  FailureHandling.CONTINUE_ON_FAILURE)
