...
WebUI.waitForElementVisible(findTestObject('Page_Folders - PowerFolder/check_daye_links'), 10)

String currentValue = WebUI.getText(findTestObject('Page_Folders - PowerFolder/check_daye_links'))
