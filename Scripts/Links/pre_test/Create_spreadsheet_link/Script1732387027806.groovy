...
String spreadsheetname = getRandomFilerName()
...
WebUI.setText(findTestObject('Object Repository/Folders/inputFolderName'), spreadsheetname)
...
String getRandomFilerName() {
	String spreadsheetname = 'spreadsheet_' + getTimestamp()
...
WebElement findShareButton(String spreadsheet) {
	WebDriver driver = DriverFactory.getWebDriver()

	return driver.findElement(By.xpath("//table[@id='files_files_table']/tbody/tr/td[2]/a[contains(text(),'$spreadsheet')]/../../td[7]/a"))
}
