...
String csvfilename = getRandomFileName()

GlobalVariable.csvfilename = csvfilename
...
WebUI.setText(findTestObject('Object Repository/Folders/inputFolderName'),csvfilename)
...
WebElement btn = findShareButton(csvfilename)
...
String getRandomFileName() {
	String fileName = 'CSV_file_' + getTimestamp()
...
WebElement findShareButton(String csvfilename) {
	WebDriver driver = DriverFactory.getWebDriver()

	return driver.findElement(By.xpath("//table[@id='files_files_table']/tbody/tr/td[2]/a[contains(text(),'$csvfilename')]/../../td[7]/a"))
}
