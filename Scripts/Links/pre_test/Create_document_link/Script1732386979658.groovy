...
String documentname = getRandomFileName()

GlobalVariable.documentname  = documentname
...
WebElement btn = findShareButton(documentname)
...
String getRandomFileName() {
	String documentname = 'document_' + getTimestamp()
