...
String presentationname = getRandomFileName()
...
WebUI.setText(findTestObject('Object Repository/Folders/inputFolderName'), presentationname)
...
WebElement btn = findShareButton(presentationname)
...
String getRandomFileName() {
	String presentationname = 'presentation_' + getTimestamp()
...
WebElement findShareButton(String presentationname) {
	WebDriver driver = DriverFactory.getWebDriver()

	return driver.findElement(By.xpath("//table[@id='files_files_table']/tbody/tr/td[2]/a[contains(text(),'$presentationname')]/../../td[7]/a"))
}
