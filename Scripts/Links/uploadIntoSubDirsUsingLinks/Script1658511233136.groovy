...
WebUI.setText(findTestObject('Object Repository/Share/Page_Folders - PowerFolder/input_Create a new Folder_pencil'), "dir2")
...
//
//WebUI.click(findTestObject('Page_Folders - PowerFolder/a_Create Folder                            _852e7b'))
//
