...
WebUI.verifyElementClickable(findTestObject('External links/Page_Activation - PowerFolder/Get server license'))

WebUI.click(findTestObject('External links/Page_Activation - PowerFolder/Get server license'))
