...
WebUI.verifyElementClickable(findTestObject('External links/Page_Login - PowerFolder/Privacy Policy'))

WebUI.delay(2)

WebUI.click(findTestObject('External links/Page_Login - PowerFolder/Privacy Policy'))
