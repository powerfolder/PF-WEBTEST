...
WebUI.verifyElementClickable(findTestObject('External links/Page_Dashboard - PowerFolder/footer_report_accessibilty'))

WebUI.delay(2)

WebUI.click(findTestObject('External links/Page_Dashboard - PowerFolder/footer_report_accessibilty'))
