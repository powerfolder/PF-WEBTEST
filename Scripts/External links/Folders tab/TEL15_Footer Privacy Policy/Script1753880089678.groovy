...
WebUI.verifyElementClickable(findTestObject('External links/Page_Dashboard - PowerFolder/footer_privacy_policy'))

WebUI.delay(2)

WebUI.click(findTestObject('External links/Page_Dashboard - PowerFolder/footer_privacy_policy'))
