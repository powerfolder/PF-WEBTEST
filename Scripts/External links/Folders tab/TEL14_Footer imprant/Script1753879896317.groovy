...
WebUI.verifyElementClickable(findTestObject('External links/Page_Dashboard - PowerFolder/footer_imprint'))

WebUI.delay(2)

WebUI.click(findTestObject('External links/Page_Dashboard - PowerFolder/footer_imprint'))
