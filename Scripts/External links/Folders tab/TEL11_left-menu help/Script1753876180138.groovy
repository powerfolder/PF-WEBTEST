...
WebUI.verifyElementClickable(findTestObject('External links/Page_Folders - PowerFolder/user_label_help'))

WebUI.click(findTestObject('External links/Page_Folders - PowerFolder/user_label_help'))
...
WebUI.verifyElementText(findTestObject('External links/Page_PowerFolder Documentation and Support/PowerFolder Documentation'),
	'PowerFolder Documentation and Support')
