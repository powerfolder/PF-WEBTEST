...
WebElement btn1 = findLink(filename)
...
String linkXpath = "//*[contains(@data-search-keys, '$filename')]/td[1]/span"

int countAfterDelete = DriverFactory.getWebDriver().findElements(By.xpath(linkXpath)).size()
