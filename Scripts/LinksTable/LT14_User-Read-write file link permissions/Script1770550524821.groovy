...
WebUI.callTestCase(findTestCase('My Account/Pre_test/Create Account'), [:], FailureHandling.OPTIONAL)
...
WebElement btn1 = findDoc(filename)

WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn1))

WebUI.click(findTestObject('LinksTable/Settings linkstab'))

boolean isChecked = WebUI.verifyElementClickable(findTestObject('LinksTable/Can read and write linkstab'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebElement findLink(String documentname) {
    WebDriver driver = DriverFactory.getWebDriver()

    return driver.findElement(By.xpath(('//*[contains(@data-search-keys, \'' + documentname) + '\')]/td[1]/span'))
}
