...
WebElement premierElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@id=\'files_files_table\']/tbody/tr[@id][1]')))
...
WebElement premierElement_bin = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@id=\'versions_table\']/tbody/tr[@id][1]')))
...
WebElement premierElement_folder = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath('//table[@id=\'files_files_table\']/tbody/tr[@id][1]')))
