...
GlobalVariable.folderName1 = (('Ordner_1' + RandomStringUtils.randomNumeric(2)) + '_') + RandomStringUtils.random(2, characters)
GlobalVariable.folderName2 = (('Ordner_2' + RandomStringUtils.randomNumeric(2)) + '_') + RandomStringUtils.random(2, characters)
...
WebElement btn2 = findFolder(folderName2)
