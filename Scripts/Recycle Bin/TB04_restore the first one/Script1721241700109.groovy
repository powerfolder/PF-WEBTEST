...
WebElement button_5 = table_5.findElement(By.xpath('./table/tbody/tr[6]/td[6]/button'))
...
def btn12 = findDoc(DocName)

WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(btn12))
