...
String binaryName = Helper.getSmartName()
...
String passWithEmogis = Helper.getSmartName()
WebUI.setText(findTestObject('Page_Link - PowerFolder/lang_Password required'), passWithEmogis)
...
WebUI.setText(findTestObject('Page_Link - PowerFolder/inputPassword'), passWithEmogis)
