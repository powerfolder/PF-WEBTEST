...
String passWithEmojis = Helper.getSmartName()

WebUI.setText(findTestObject('Page_Link - PowerFolder/lang_Password required'), passWithEmojis)
...
WebUI.setText(findTestObject('Page_Link - PowerFolder/inputPassword'), passWithEmojis)
