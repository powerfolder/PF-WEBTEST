...
WebUI.click(findTestObject('Links/Page_Link - PowerFolder/Qr'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Links/Page_Link - PowerFolder/Qr_canvas'), 10)

WebUI.verifyElementVisible(findTestObject('Links/Page_Link - PowerFolder/Qr_canvas'))
