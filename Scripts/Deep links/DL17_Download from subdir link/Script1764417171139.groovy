...
// Create Link
WebElement btn3 = Helper.findShareButton(subSubDirectory)
...
TestObject firstCell = new TestObject()

firstCell.addProperty("xpath", ConditionType.EQUALS, "(//table//tbody//tr//td[2])[1]")

WebUI.click(firstCell)

WebUI.click(findTestObject('Object Repository/Page_Link - PowerFolder/Download'))
...
assert isFileDownloaded(downloadPath, imageName)
