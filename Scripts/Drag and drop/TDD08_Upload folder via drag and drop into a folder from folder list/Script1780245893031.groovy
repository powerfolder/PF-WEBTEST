...
// ================== OPEN TARGET FOLDER TO VERIFY UPLOADED FOLDER ==================
...
// ================== VERIFY LOCAL FOLDER UPLOADED INSIDE TARGET FOLDER ==================

boolean uploaded = driver.findElements(
	By.xpath("//table[@id='files_files_table']//*[contains(text(),'" + localFolderName + "')]")
).size() > 0
