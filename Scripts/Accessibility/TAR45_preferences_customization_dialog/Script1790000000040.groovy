...
// The "Customization" tile opens #pica_preference_dialog with sub-tabs for Plugins and
// Licensing.
...
categoryButton.addProperty('xpath', ConditionType.EQUALS, "//*[@id='button-customization']")
