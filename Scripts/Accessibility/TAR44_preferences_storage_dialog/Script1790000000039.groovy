...
// The "Storage" tile opens #pica_preference_dialog with sub-tabs for Recycle Bin,
// Folder Scan and the base storage/archiving settings.
...
categoryButton.addProperty('xpath', ConditionType.EQUALS, "//*[@id='button-storage']")
