...
// Test Cases/My Account/Overview tab/TMA06_Change Language to open the
...
WebUI.verifyElementClickable(findTestObject('My_Account/Overview/Page_Profile - PowerFolder/Change_Language'))

WebUI.click(findTestObject('My_Account/Overview/Page_Profile - PowerFolder/Change_Language'))

WebUI.delay(3)

// Scans the "Change Language" dialog while it is open.
