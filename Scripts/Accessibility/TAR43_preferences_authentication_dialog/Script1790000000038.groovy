...
// The "Authentication" tile opens #pica_preference_dialog with sub-tabs for LDAP, ACL,
// Auth Chain, Kerberos SSO, RADIUS, SAML/Shibboleth, Auth order and MFA.
...
categoryButton.addProperty('xpath', ConditionType.EQUALS, "//*[@id='button-authentication']")
