...
// Follows the same create-folder -> select -> Manage flow as
// Test Cases/Folders/TF6_VerifyExistingFolderManage, but stops to scan the folder
// "settings" dialog (ManagePopup: base path, rescan, delete) while it is open.

WebUI.callTestCase(findTestCase('Folders/PreTest_GoToShareable'), [:], FailureHandling.STOP_ON_FAILURE)

String folderName = 'TAR51_' + getRandomFolderName()
...
// Scans the folder settings dialog while it is open.
