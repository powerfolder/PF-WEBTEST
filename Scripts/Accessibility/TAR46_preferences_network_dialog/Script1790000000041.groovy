...
// The "Network" tile opens #pica_preference_dialog with sub-tabs for Proxy, Names and
// URLs, IPs and Ports, and SMB.
...
categoryButton.addProperty('xpath', ConditionType.EQUALS, "//*[@id='button-network']")
