...
// The "Web" tile opens #pica_preference_dialog with sub-tabs for Open Files In Web,
// Open Files In Web URLs, Search and Features.
...
categoryButton.addProperty('xpath', ConditionType.EQUALS, "//*[@id='button-web']")
