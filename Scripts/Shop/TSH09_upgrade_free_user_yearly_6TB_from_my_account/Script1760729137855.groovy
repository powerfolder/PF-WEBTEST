...
WebUI.setText(findTestObject('Page_PowerFolder - shop_stripe/input_Name desder Karteninhaberin_billingName'), 'TSH09 Testcheckout')
...
WebUI.closeBrowser( // add 1 yeat + 12 days
    )
...
String getTimestamp() {
    ...
    use(groovy.time.TimeCategory, { 
            todaysDate = ((todaysDate + 1.year) + 12.days)
        })
