...
String subAName = TagHelper.createSubfolder()
...
String tagText = 'sfs33' + RandomStringUtils.randomAlphanumeric(6).toLowerCase()
...
WebUI.verifyEqual(TagHelper.isTagFilterActive(tagText), true)
WebUI.verifyEqual(TagHelper.rowExistsEventually(docName, 10), true)
