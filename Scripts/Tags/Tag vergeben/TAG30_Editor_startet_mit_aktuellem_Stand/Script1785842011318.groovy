...
String tag1 = 'TAG30_A_' + RandomStringUtils.randomAlphanumeric(6)
String tag2 = 'TAG30_B_' + RandomStringUtils.randomAlphanumeric(6)

TagHelper.openTagEditorViaActionbar(docName)
TagHelper.addTag(tag1)
TagHelper.saveEditorViaEnter()
WebUI.refresh()
WebUI.delay(2)

// Editor ueber einen ANDEREN Einstiegspunkt erneut oeffnen - er muss mit tag1 starten,
// nicht mit einem veralteten (leeren) Zwischenstand - Regressionstest fuer Commit 80f2e201ce
TagHelper.openTagEditorViaRowMenu(docName)
assert TagHelper.getEditorChipTexts().contains(tag1)
