...
///////////////////////////Folder_1/////////////////////////////////////////
folderName_1 = getRandomFolderName()
...
Document_1_in_foder_2 = ('Doc_num_' + RandomStringUtils.randomNumeric(4))

WebUI.setText(findTestObject('file_objects/document/Page_Folders - PowerFolder/Page_Folders - PowerFolder/set_folder_name'), 
    Document_1_in_foder_2)
...
Document_2_in_foder_2 = ('Doc_num_' + RandomStringUtils.randomNumeric(4))

WebUI.setText(findTestObject('file_objects/document/Page_Folders - PowerFolder/Page_Folders - PowerFolder/set_folder_name'), 
    Document_2_in_foder_2)
...
///////////////////////////Folder_3/////////////////////////////////////////
folderName_3 = getRandomFolderName()
...
WebUI.setText(findTestObject('Object Repository/Folders/inputFolderName'), folderName_3)
...
Document_1_in_folder_3 = ('Doc_num_' + RandomStringUtils.randomNumeric(4))

WebUI.setText(findTestObject('file_objects/document/Page_Folders - PowerFolder/Page_Folders - PowerFolder/set_folder_name'), 
    Document_1_in_folder_3)
...
Document_2_in_folder_3 = ('Doc_num_' + RandomStringUtils.randomNumeric(4))

WebUI.setText(findTestObject('file_objects/document/Page_Folders - PowerFolder/Page_Folders - PowerFolder/set_folder_name'), 
    Document_2_in_folder_3)
...
Document_3_in_folder_3 = ('Doc_num_' + RandomStringUtils.randomNumeric(4))

WebUI.setText(findTestObject('file_objects/document/Page_Folders - PowerFolder/Page_Folders - PowerFolder/set_folder_name'), 
    Document_3_in_folder_3)
...
WebUI.verifyElementText(findTestObject('News_User/Page_News - PowerFolder/Most active folders'), 'Most active folders')

TestObject firstMostActiveFolder = new TestObject('firstMostActiveFolder')

firstMostActiveFolder.addProperty('xpath', com.kms.katalon.core.testobject.ConditionType.EQUALS, '(//h3[normalize-space()=\'Most active folders\']/following::div[contains(@class,\'pf-stat-row\')][1]//a)[1]')

WebUI.verifyElementText(firstMostActiveFolder, folderName_3)
