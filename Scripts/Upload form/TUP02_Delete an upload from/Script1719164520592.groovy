...
WebUI.verifyElementClickable(findTestObject('1Upload_Form/Page_Folders - PowerFolder/Page_Folders - PowerFolder/Delete_Upload_Form'))

WebUI.click(findTestObject('1Upload_Form/Page_Folders - PowerFolder/Page_Folders - PowerFolder/Delete_Upload_Form'))
